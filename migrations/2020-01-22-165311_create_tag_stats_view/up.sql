...
select tag_name,
       photos_with_tag,
       (photos_with_tag::numeric / photos_with_tags::numeric) * 100                  percentage_with_tag,
       (photos_with_tag::numeric / (select count(*)::numeric from photos_all)) * 100 percentage_total
