use actix_web::{HttpResponse, web, get, post, patch, delete};
...
#[get("/collections/{id}")]
pub async fn get_collection(info: web::Path<i32>, pool: web::Data<Pool>) -> Result<HttpResponse, errors::Error> {
...
#[post("/collections")]
pub async fn create_collection(params: web::Json<NewCollection>, pool: web::Data<Pool>) -> Result<HttpResponse, errors::Error> {
...
pub async fn update_collection(_: web::Path<i32>, params: web::Json<Collection>, pool: web::Data<Pool>) -> Result<HttpResponse, errors::Error> {
...
pub async fn delete_collection(info: web::Path<i32>, pool: web::Data<Pool>) -> Result<HttpResponse, errors::Error> {
